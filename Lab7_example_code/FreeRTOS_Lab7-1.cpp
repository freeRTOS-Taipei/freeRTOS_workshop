...
#define AutoReload_TIMER_PERIOD MS_TO_TICK( 3000 )
const TickType_t xHealthyTimerPeriod = MS_TO_TICK( 3000 );
...
static void vEventBitSettingTask( void *pvParameters )
{
const TickType_t xDelay1000ms = pdMS_TO_TICKS( 1000UL ), xDontBlock = 0;
	...
	for( ;; )
	{
		...
		Serial.print( "Bit setting task -\t about to set bit 0.\r\n" );
		...
		Serial.print( "Bit setting task -\t about to set bit 1.\r\n" );
...
EventBits_t xEventGroupValue;
	...
	for( ;; )
	{
		...
		{
			Serial.print( "Bit reading task -\t event bit 0 was set\r\n" );
		}

		if( ( xEventGroupValue & mainSECOND_TASK_BIT ) != 0 )
		{
			Serial.print( "Bit reading task -\t event bit 1 was set\r\n" );
		}

		if( ( xEventGroupValue & mainISR_BIT ) != 0 )
		{
			Serial.print( "Bit reading task -\t event bit 2 was set\r\n" );
		}
...
void vPrintStringFromDaemonTask( void *pvParameter1, uint32_t ulParameter2 )
{
	...
	parameter. */
	Serial.print( ( const char * ) pvParameter1 );
}
/*-----------------------------------------------------------*/
